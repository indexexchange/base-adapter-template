...
function %%PartnerName%%%%PartnerType%%(configs) {
    ...
    function __parseResponse(sessionId, adResponse, returnParcels) {
        ...
        for (var j = 0; j < returnParcels.length; j++) {
            ...
            /* The targeting information if applicable for this slot. */
            var targetingInfo = curBid;
            ...
            /* Based on the targeting information, assign targeting values to curReturnParcel. Targeting key can be
             * defined by partners, make sure your key is unique, we suggest using the format ix_%%partnerid%%_info */

            //? if (FEATURES.GPT_LINE_ITEMS) {
            if (targetingInfo) {
                curReturnParcel.targeting[key] = [targetingInfo.value];
            }
            //? }
        }
    }
